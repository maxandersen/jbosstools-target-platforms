...
Template to copy for easy creation:
...
<!-- Only in JBT: GWT/GPE -->
    <location includeAllPlatforms="false" includeMode="planner" type="InstallableUnit" includeSource="true">
      <repository location="http://download.jboss.org/jbosstools/updates/requirements/gwt/3.2.0.v201302131858-rel-r42/"/>
      <unit id="com.google.gdt.eclipse.suite.e42.feature.feature.group" version="3.2.0.v201302131858-rel-r42"/>
      <unit id="com.google.gwt.eclipse.sdkbundle.feature.feature.group" version="2.5.0"/>
    </location>
----
...
Once this is built you can test it in your build by running:

 $ mvn verify -Dtpc.version=4.30.5.Alpha3-SNAPSHOT

where the `tpc.version` is the version listed in the `pom.xml` file of the target platform.
